use crate::database::{
    models::{
        Athlete, EventTrigger, NetworkInterface, ObsRecordingConfig, ObsRecordingSession, Octagon,
        OvrCategory, OvrTournament, PssAthlete, PssEventDetail, PssEventRecognitionHistory,
...
fn overv<T: ToString>(value: Option<T>) -> Option<String> {
    value.map(|item| item.to_string())
}

fn overv_dt(value: Option<chrono::DateTime<chrono::Utc>>) -> Option<String> {

...
async fn main() -> AppResult<()> {
    ...
    let tauri_result = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::system::cpu_get_process_data,
            commands::system::cpu_get_system_data,
            commands::system::cpu_enable_monitoring,
            commands::system::cpu_disable_monitoring,
            commands::system::cpu_get_monitoring_status,
            ...
            // Database commands
            // tauri_commands::initialize_ui_settings_database, // Deprecated/Removed
            commands::database::db_initialize_ui_settings,
            commands::database::db_get_ui_setting,
            commands::database::db_set_ui_setting,
            commands::database::db_get_all_ui_settings,
            commands::database::db_get_database_info,
            commands::database::migrate_json_to_database,
            commands::database::db_run_migrations,
            commands::database::get_migration_status,
            commands::database::enable_database_mode,
            commands::database::get_database_preview,
            ...
            commands::database::db_create_sqlite_backup,
            commands::database::db_list_sqlite_backups,
            commands::database::db_restore_sqlite_backup,
            ...
            commands::google_drive::drive_request_auth_url,
            commands::google_drive::drive_complete_auth,
            commands::google_drive::drive_save_credentials,
            commands::google_drive::drive_list_files,
            commands::google_drive::drive_list_all_files,
            commands::google_drive::drive_test_connection,
            commands::google_drive::drive_upload_backup_archive,
            commands::google_drive::drive_download_backup_archive,
            commands::google_drive::drive_restore_from_archive,
            commands::google_drive::drive_delete_backup_archive,
            commands::google_drive::drive_get_connection_status,
            commands::google_drive::drive_get_quota,
            commands::google_drive::drive_create_folder,
            commands::google_drive::drive_list_children,
            commands::google_drive::drive_upload_zip_to_folder,

...
async fn main() -> AppResult<()> {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            tauri_commands::obs_start_streaming,
            tauri_commands::obs_stop_streaming,
            tauri_commands::obs_get_streaming_status,
            tauri_commands::obs_get_current_scene,
            tauri_commands::obs_set_current_scene,
            ...
            tauri_commands::obs_get_replay_buffer_status,
            tauri_commands::obs_start_replay_buffer,
            tauri_commands::obs_stop_replay_buffer,
            tauri_commands::obs_save_replay_buffer,

...
async fn main() -> AppResult<()> {
    ...
    let tauri_result = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            re_strike_vta::tauri_commands_medal_ceremony::medal_ceremony_get,
            re_strike_vta::tauri_commands_medal_ceremony::medal_ceremony_save,
            re_strike_vta::tauri_commands_medal_ceremony::medal_ceremony_delete,
            re_strike_vta::tauri_commands_medal_ceremony::medal_ceremony_prepare,
            re_strike_vta::tauri_commands_medal_ceremony::medal_ceremony_mark_division_played,
            re_strike_vta::tauri_commands_medal_ceremony::medal_ceremony_reset_playback,
            re_strike_vta::tauri_commands_medal_ceremony::medal_ceremony_set_show_external,
            re_strike_vta::tauri_commands_medal_ceremony::medal_ceremony_list_flag_assets,
            re_strike_vta::tauri_commands_medal_ceremony::medal_ceremony_save_flag_asset,
            re_strike_vta::tauri_commands_medal_ceremony::medal_ceremony_delete_flag_asset,
            re_strike_vta::tauri_commands_medal_ceremony::medal_ceremony_list_anthems,
            re_strike_vta::tauri_commands_medal_ceremony::medal_ceremony_save_anthem,
            re_strike_vta::tauri_commands_medal_ceremony::medal_ceremony_delete_anthem,
            ...
            // OBS Commands
            commands::obs::obs_obws_get_connections,
            commands::obs::obs_obws_remove_connection,
            commands::obs::obs_obws_get_status,
            commands::obs::obs_obws_start_recording,
            commands::obs::obs_obws_stop_recording,
            commands::obs::obs_obws_get_recording_status,
            commands::obs::obs_obws_start_streaming,
            commands::obs::obs_obws_stop_streaming,
            commands::obs::obs_obws_get_streaming_status,
            commands::obs::obs_obws_get_current_scene,
            commands::obs::obs_obws_set_current_scene,
            commands::obs::obs_obws_get_version,
            commands::obs::obs_obws_save_replay_buffer,
            commands::obs::obs_obws_get_replay_buffer_status,
            commands::obs::obs_obws_get_recording_path_settings,
            commands::obs::obs_obws_set_recording_path,
            commands::obs::obs_obws_set_recording_filename,
            commands::obs::obs_obws_set_source_visibility,
            commands::obs::ivr_open_event_video,
            commands::obs::ivr_validate_mpv_path,
            commands::obs::ivr_open_video_file,
            commands::obs::obs_obws_add_connection,

...
pub mod plugin_file_server;  // File server for HTML overlays
...
pub use plugin_file_server::FileServerPlugin;
...
pub async fn init() -> Result<(), Box<dyn std::error::Error>> {
    ...
    plugin_file_server::init()?;  // File server for HTML overlays

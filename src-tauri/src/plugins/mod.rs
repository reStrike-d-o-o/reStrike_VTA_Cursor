...
pub use plugin_cpu_monitor::{CpuMonitorConfig, CpuMonitorPlugin}; // Added CpuMonitorConfig
...
pub use performance_monitor::{MemoryUsageStats, PerformanceMetrics, PerformanceMonitor};

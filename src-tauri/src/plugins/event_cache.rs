...
impl EventCache {
    ...
    pub async fn set_tournament_events(
        &self,
        tournament_id: i64,
    ...
    pub async fn set_athlete_stats(
        &self,
        athlete_id: i64,
    ...
    pub async fn set_tournament_stats(
        &self,
        tournament_id: i64,
    ...
    pub async fn get_cache_stats(&self) -> CacheStatistics {
        ...
        CacheStatistics {
            ...
            match_stats_count,
            total_entries: tournament_events_count
                + match_events_count
                + athlete_stats_count
                + tournament_stats_count
                + match_stats_count,
    ...
    fn cleanup_cache<T>(&self, cache: &mut HashMap<i64, CacheEntry<T>>, max_size: usize) {
        ...
        if cache.len() > max_size {
            ...
            let keys_to_remove: Vec<i64> = entries
                .iter()
                .take(to_remove)
                .map(|(key, _)| **key)
                .collect();

...
pub mod prelude {
    ...
    pub use super::settings_category::Entity as SettingsCategory;
    pub use super::settings_history::Entity as SettingsHistory;
    pub use super::settings_key::Entity as SettingsKey;
    pub use super::settings_value::Entity as SettingsValue;
